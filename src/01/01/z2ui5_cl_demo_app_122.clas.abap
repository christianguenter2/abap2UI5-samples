...
CLASS Z2UI5_CL_DEMO_APP_122 IMPLEMENTATION.
  ...
  METHOD read_frontend_info.
    ...
    temp3 = boolc( ls_get-s_device-system = z2ui5_if_types=>cs_device-system-phone ).
    device_phone           = temp3.
    
    temp4 = boolc( ls_get-s_device-system = z2ui5_if_types=>cs_device-system-desktop ).
    device_desktop         = temp4.
    
    temp5 = boolc( ls_get-s_device-system = z2ui5_if_types=>cs_device-system-tablet ).
    device_tablet          = temp5.
    
    temp6 = boolc( ls_get-s_device-system = z2ui5_if_types=>cs_device-system-combi ).
    device_combi           = temp6.
